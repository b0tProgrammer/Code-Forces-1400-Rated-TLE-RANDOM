...
//            Comparator<Pair> com = Comparator.comparingInt(i -> i.v1);
            ...
            while(testcases-- > 0) {
                ...
                // Check the pattern on how it's changing!

                // if you carefully observe the pattern, that looks in this way!

                // The Main pattern is like if you half the number then the number of changes is equal to n!
