...
//            testcases = in.nextInt();
            ...
            while(testcases-- > 0) {
                ...
                /*
                    ...
                    We need to find the minimum length of tape required after k cuts


                    let's start with k = 1 then ew have to cut tape only once so, minimum length will be nums[n-1]-nums[0]+1

                    so if k = 2 then the minimum length will be the length for k = 1 - the greatest length in this way, we can find the answer!
